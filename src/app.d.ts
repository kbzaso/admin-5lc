...
export interface Clerk {
	<T extends ClerkEndpoints>(method: 'call', endpoint: T, config?: ConfigType<T>): Promise<
		ClerkResponseType<T>
	>;
...
export type ConfigType<T extends ClerkEndpoints> = T extends keyof ConfigTypes
	? ConfigTypes[T]
	: never;
...
export type ClerkResponseType<T extends ClerkEndpoints> = T extends keyof ClerkResponseTypes
	? ClerkResponseTypes[T]
	: never;
