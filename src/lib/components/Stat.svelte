...
<div class="stats shadow bg-gray-800 mb-6 mt-4">
  <div class="stat">
    ...
    <div class="stat">
      ...
      <div class="stat-desc text-secondary">En comparación con {originalStudioStock} total</div>
    </div>
