...
<div class="h-full grow grid place-items-center">
	<form method="post" use:enhance class="space-y-4 w-full max-w-md">
		<label for="username" class="form-control w-full max-w-md">
			<div class="label">
				<span class="label-text">Email de usuario <span class="text-secondary">*</span></span>
			</div>
			<input
		...
		<div class="text-center">
			...
			<a href="/signup" class="text-info underline">Crear una cuenta</a>
		</div>
	</form>
</div>
